...
public class Main {
    ...
    private  static List<Album> albums = new ArrayList<Album>();     // LinkedList is changed to List
    ...
    public static void main(String[] args) {
        ...
        List<Song> rajs_meditation_songs_playlist = new ArrayList<Song>();   // LinkedList is changed to List in LHS and Arraylist in RHS
    ...
    private static void play(List<Song> playlist){   // LinkedList is changed to List
    ...
    private static void printList(List<Song> playList) {   // LinkedList is changed to List
